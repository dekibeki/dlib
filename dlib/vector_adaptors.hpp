...
namespace dlib {
  ...
  //class Allocating_vector {
  //public:
  //  using Storage = std::aligned_storage_t<sizeof(T), alignof(T)>;
  //  using Holder = Vector<Storage>;
  ...
  //  reference convert_(Storage& storage) {
  //    return *reinterpret_cast<pointer>(&storage);
  //  }

  //  const_reference convert_(Storage const& storage) {
